...
async function main() {
  ...
  const adminGroup = await prisma.permissionGroup.upsert({
    ...
    create: {
      ...
      canViewOrders: true, canUploadExcel: true, canDeleteOrders: true, canEditStaffNotes: true, canExportOrdersCustomer: true, canExportOrdersInternal: true, canUseAdvancedFilters: true,
      canViewRevenue: true, canViewCarrierFee: true, canViewFinancePage: true, canViewDashboardFinance: true,
      canManageExpenses: true, canUploadCashbook: true, canManageBudgets: true,
      canViewDelayed: true, canViewReturns: true, canConfirmReturn: true,
      canViewClaims: true, canCreateClaim: true, canUpdateClaim: true, canDeleteClaim: true, canViewClaimsTools: true, canViewCompensation: true,
      canViewAllTodos: true,
      canViewAllAttendance: true, canEditAttendance: true,
      canApproveLeave: true,
      canManageDocuments: true, canManageLinks: true,
      canCreateAnnouncement: true,
      canManageUsers: true, canManagePermissions: true,
      canViewCRM: true, canManageCRM: true, canEditShopInfo: true, canViewAllShops: true,
    },
  });
  ...
  const managerGroup = await prisma.permissionGroup.upsert({
    ...
    create: {
      ...
      canViewCRM: true, canManageCRM: false, canEditShopInfo: true, canViewAllShops: true,
    },
  });
  ...
  const staffGroup = await prisma.permissionGroup.upsert({
    ...
    create: {
      ...
      isSystemGroup: true,
      canViewDashboard: true,
      canViewOrders: true, canUploadExcel: true, canDeleteOrders: false, canEditStaffNotes: true, canExportOrdersCustomer: true, canExportOrdersInternal: false, canUseAdvancedFilters: true,
      canViewRevenue: false, canViewCarrierFee: false, canViewFinancePage: false, canViewDashboardFinance: false,
      canManageExpenses: false, canUploadCashbook: false, canManageBudgets: false,
      canViewDelayed: true, canViewReturns: true, canConfirmReturn: false,
      canViewClaims: true, canCreateClaim: true, canUpdateClaim: false, canDeleteClaim: false, canViewClaimsTools: false, canViewCompensation: false,
      canViewAllTodos: false,
      canViewAllAttendance: false, canEditAttendance: false,
      canApproveLeave: false,
      canManageDocuments: false, canManageLinks: false,
      canCreateAnnouncement: false,
      canManageUsers: false, canManagePermissions: false,
      canViewCRM: true, canManageCRM: false, canEditShopInfo: true, canViewAllShops: false,
    },
  });
  ...
  const viewerGroup = await prisma.permissionGroup.upsert({
    ...
    create: {
      ...
      isSystemGroup: true,
      canViewDashboard: true,
      canViewOrders: true, canUploadExcel: false, canDeleteOrders: false, canEditStaffNotes: false, canExportOrdersCustomer: false, canExportOrdersInternal: false, canUseAdvancedFilters: false,
      canViewRevenue: false, canViewCarrierFee: false, canViewFinancePage: false, canViewDashboardFinance: false,
      canManageExpenses: false, canUploadCashbook: false, canManageBudgets: false,
      canViewDelayed: true, canViewReturns: true, canConfirmReturn: false,
      canViewClaims: true, canCreateClaim: false, canUpdateClaim: false, canDeleteClaim: false, canViewClaimsTools: false, canViewCompensation: false,
      canViewAllTodos: false,
      canViewAllAttendance: false, canEditAttendance: false,
      canApproveLeave: false,
      canManageDocuments: false, canManageLinks: false,
      canCreateAnnouncement: false,
      canManageUsers: false, canManagePermissions: false,
      canViewCRM: true, canManageCRM: false, canEditShopInfo: false, canViewAllShops: false,
    },
  });
