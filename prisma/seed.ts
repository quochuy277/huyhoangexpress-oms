...
async function main() {
  ...
  const adminGroup = await prisma.permissionGroup.upsert({
    ...
    create: {
      ...
      canViewOrders: true, canUploadExcel: true, canDeleteOrders: true, canEditStaffNotes: true, canExportOrders: true, canUseAdvancedFilters: true,
  ...
  const staffGroup = await prisma.permissionGroup.upsert({
    ...
    create: {
      ...
      isSystemGroup: true,
      canViewDashboard: true,
      canViewOrders: true, canUploadExcel: true, canDeleteOrders: false, canEditStaffNotes: true, canExportOrders: false, canUseAdvancedFilters: true,
  ...
  const viewerGroup = await prisma.permissionGroup.upsert({
    ...
    create: {
      ...
      isSystemGroup: true,
      canViewDashboard: true,
      canViewOrders: true, canUploadExcel: false, canDeleteOrders: false, canEditStaffNotes: false, canExportOrders: false, canUseAdvancedFilters: false,
      canViewRevenue: false, canViewCarrierFee: false, canViewFinancePage: false, canViewDashboardFinance: false,
      canManageExpenses: false, canUploadCashbook: false, canManageBudgets: false,
      canViewDelayed: true, canViewReturns: true, canConfirmReturn: false,
