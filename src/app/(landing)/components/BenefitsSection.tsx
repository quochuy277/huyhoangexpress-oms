      ...
      <div ref={ref} className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
          {BENEFITS.map((b, i) => (
            <div
              key={i}
              className={`group flex gap-4 p-6 bg-white rounded-2xl border border-slate-100 hover:border-[#0ea5e9]/30 hover:shadow-lg transition-all duration-500 ${
                visible
            ...
            >
              <div className="shrink-0 inline-flex p-3 h-fit rounded-xl bg-[#1a3a4a]/5 text-[#1a3a4a] group-hover:bg-[#0ea5e9]/10 group-hover:text-[#0ea5e9] transition-colors duration-300">
